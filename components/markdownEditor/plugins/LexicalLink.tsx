...
export class LinkNode extends ElementNode {
  ...
  constructor(url: string, attributes: LinkAttributes = {}, key?: NodeKey, className?: string) {
    super(key);
  ...
  updateDOM(
    ...
    if (className !== prevNode.__className) {
      if (className) {
  ...
  setClassName(className: null | string): void {
    const writable = this.getWritable();
